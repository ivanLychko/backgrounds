  ...
  animate() {
    ...
    this.lines.forEach(line => {
      ...
      if (dist1 < 100 && dist1 > 0) {
        ...
        line.vx1 += (dx1 / dist1) * force * 0.1;
        line.vy1 += (dy1 / dist1) * force * 0.1;
      }
      ...
      if (dist2 < 100 && dist2 > 0) {
        ...
        line.vx2 += (dx2 / dist2) * force * 0.1;
        line.vy2 += (dy2 / dist2) * force * 0.1;
      }
      
      // Boundary
      if (line.x1 < 0 || line.x1 > this.canvas.width) line.vx1 *= -1;
      if (line.y1 < 0 || line.y1 > this.canvas.height) line.vy1 *= -1;
      if (line.x2 < 0 || line.x2 > this.canvas.width) line.vx2 *= -1;
      if (line.y2 < 0 || line.y2 > this.canvas.height) line.vy2 *= -1;
      ...
      gradient.addColorStop(0, `hsla(${line.hue}, 70%, 60%, 0.6)`);
      gradient.addColorStop(1, `hsla(${line.hue + 60}, 70%, 60%, 0.6)`);
