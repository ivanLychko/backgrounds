class ParallaxBackground {
  ...
  drawLayer(layer) {
    ...
    layer.cells.forEach(cell => {
      const offsetX = (this.mouse.x - 0.5) * layer.depth * 100;
      const offsetY = (this.mouse.y - 0.5) * layer.depth * 100;
      ...
      if (distance < 200 * (1 + layer.depth)) {
        const opacity = (1 - distance / (200 * (1 + layer.depth))) * 0.3;
